 ...
 * @author KLASTER
 */
public class ModelFrame49 extends javax.swing.JFrame {
    ...
    public void Graphics(Graphics g, int push_ToArr){
        ...
        //if (gstartI > -1){
            ...
            for(int n = 0; n < maxSamples; n++){
                ...
                //ti = 200;
                double value = a * (1 + m * Math.cos(Math.toRadians(360) * fo * t)) * Math.cos(Math.toRadians(360) * fn * t + fi);
    ...
    public void paint(Graphics g) {
        modelFrameWidth = modelFrame9.getWidth();
        modelFrameHeight = modelFrame9.getHeight();
    ...
    private void initComponents() {
        ...
        TextField44 = new javax.swing.JTextField();
        jLabel9 = new javax.swing.JLabel();
        jPanel11 = new javax.swing.JPanel();
        TextField55 = new javax.swing.JTextField();
        ...
        setTitle("Сигнал с тональной огибающей");
        setAlwaysOnTop(true);

        jPanel6.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Шаблоны данных");
        ...
        jLabel7.setText("Начальная фаза ( φ )");
        ...
        jLabel8.setText("Частота несущей ( fn )");
        ...
        TextField44.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jLabel9.setText("Амплитуда сигнала ( a )");
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TextField44, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28))
        );

        jPanel11.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        TextField55.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jLabel10.setText("Глубина модуляции ( m )");
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TextField55, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28))
        );
    ...
    private void SelectButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SelectButton1ActionPerformed
        fi = Double.parseDouble(TextField11.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        fi = Double.valueOf(0.03);
        TextField33.setText(String.valueOf(fi));
        fo = Double.valueOf(0.001);
        TextField22.setText(String.valueOf(fo));
        fn = Double.valueOf(0.02);
        TextField11.setText(String.valueOf(fn));
        a = Double.valueOf(50);
        TextField44.setText(String.valueOf(a));
        m = Double.valueOf(1.0);
        TextField55.setText(String.valueOf(m));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        fi = Double.valueOf(1.23);
        TextField33.setText(String.valueOf(fi));
        fo = Double.valueOf(0.01);
        TextField22.setText(String.valueOf(fo));
        fn = Double.valueOf(0.02);
        TextField11.setText(String.valueOf(fn));
        a = Double.valueOf(2.0);
        TextField44.setText(String.valueOf(a));
        m = Double.valueOf(0.5);
        TextField55.setText(String.valueOf(m));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        fi = Double.valueOf(1.28);
        TextField33.setText(String.valueOf(fi));
        fo = Double.valueOf(0.01);
        TextField22.setText(String.valueOf(fo));
        fn = Double.valueOf(0.002);
        TextField11.setText(String.valueOf(fn));
        a = Double.valueOf(1.0);
        TextField44.setText(String.valueOf(a));
        m = Double.valueOf(0.3);
        TextField55.setText(String.valueOf(m));
    ...
    public static javax.swing.JTextField TextField44;
    public static javax.swing.JTextField TextField55;
