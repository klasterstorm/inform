...
import static inform.MainFrame.modelFrame12;
 ...
 * @author KLASTER
 */
public class ModelFrame52 extends javax.swing.JFrame {
...
//                b[10] = "0.9";
                ...
                JA0.setText(String.valueOf(a.length - 1));
                JB0.setText(String.valueOf(b.length - 1));
    ...
    public void paint(Graphics g) {
        modelFrameWidth = modelFrame12.getWidth();
        modelFrameHeight = modelFrame12.getHeight();
        TextField11.setText(String.valueOf(q));
        TextField22.setText(String.valueOf(p));
    ...
    private void initComponents() {
        ...
        JB0 = new javax.swing.JLabel();
        JA0 = new javax.swing.JLabel();
        ...
        setTitle("Cлучайного сигнал авторегрессии-скользящего среднего порядка (p,q) ");
        setAlwaysOnTop(true);
        ...
        jLabel9.setText("Данные вводятся через ;");
    ...
    private void SelectButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SelectButton1ActionPerformed
        ...
        q = Double.parseDouble(TextField11.getText());
        p = Double.parseDouble(TextField22.getText());
    ...
    private javax.swing.JLabel JA0;
    private javax.swing.JTextArea JB;
    private javax.swing.JLabel JB0;
